package com.xy.springbootvue.generate;
...
//        assert (false) : "代码生成属于危险操作，请确定配置后取消断言执行代码生成！";
        ...
        gc.setAuthor("bearsmall");
        gc.setOutputDir("D:\\Users\\bearsmall\\IdeaProjects\\spring-boot-vue\\src\\main\\java");
...
//        strategy.setTablePrefix(new String[] { "project_" });// 此处可以修改为您的表前缀
        ...
        strategy.setInclude(new String[] { "projectTask" }); // 需要生成的表
        ...
        pc.setParent("com.xy.springbootvue");
